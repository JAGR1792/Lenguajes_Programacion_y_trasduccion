...
#line 20 "ejemplo5.y"
                     { printf("= %d\n", (yyvsp[-1].ival)); }
#line 1073 "ejemplo5.tab.c"
    break;

  case 4: /* exp: factor  */
#line 24 "ejemplo5.y"
           { (yyval.ival) = (yyvsp[0].ival); }
#line 1079 "ejemplo5.tab.c"
    break;

  case 5: /* exp: exp ADD factor  */
#line 25 "ejemplo5.y"
                   { (yyval.ival) = (yyvsp[-2].ival) + (yyvsp[0].ival); }
#line 1085 "ejemplo5.tab.c"
    break;

  case 6: /* exp: exp SUB factor  */
#line 26 "ejemplo5.y"
                   { (yyval.ival) = (yyvsp[-2].ival) - (yyvsp[0].ival); }
#line 1091 "ejemplo5.tab.c"
    break;

  case 7: /* factor: term  */
#line 30 "ejemplo5.y"
         { (yyval.ival) = (yyvsp[0].ival); }
#line 1097 "ejemplo5.tab.c"
    break;

  case 8: /* factor: factor MUL term  */
#line 31 "ejemplo5.y"
                    { (yyval.ival) = (yyvsp[-2].ival) * (yyvsp[0].ival); }
#line 1103 "ejemplo5.tab.c"
    break;

  case 9: /* factor: factor DIV term  */
#line 32 "ejemplo5.y"
                    { (yyval.ival) = (yyvsp[-2].ival) / (yyvsp[0].ival); }
#line 1109 "ejemplo5.tab.c"
    break;

  case 10: /* term: NUMBER  */
#line 36 "ejemplo5.y"
           { (yyval.ival) = (yyvsp[0].ival); }
#line 1115 "ejemplo5.tab.c"
    break;

  case 11: /* term: ABS term  */
#line 37 "ejemplo5.y"
             { (yyval.ival) = (yyvsp[0].ival) >= 0 ? (yyvsp[0].ival) : -(yyvsp[0].ival); }
#line 1121 "ejemplo5.tab.c"
    break;


#line 1125 "ejemplo5.tab.c"
